  ...
  <div class="row">
   ...
   <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="table1">
    <form class="needs-validation" action="" method="POST">
      ...
      <div class=" md-form mt-0">
        <input id="myInput1" class="form-control" type="text" placeholder="Search" aria-label="Search">
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-lg">
          <?php
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="signinc">
     <form class="needs-validation" action="" method="POST">
        ...
        <div class=" md-form mt-0">
        <input id="myInput2" class="form-control" type="text" placeholder="Search" aria-label="Search">
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-lg">
          <?php
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="signins">
     <form class="needs-validation" action="" method="POST">
        ...
        <div class=" md-form mt-0">
        <input id="myInput3" class="form-control" type="text" placeholder="Search" aria-label="Search">
      </div>
      <div class="table-responsive">
        <table class="table table-striped table-lg">
          <?php
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="signup">
           <form class="needs-validation" action="" method="POST">
              ...
              <div class=" md-form mt-0">
        <input id="myInput4" class="form-control" type="text" placeholder="Search" aria-label="Search">
      </div>
            <div class="table-responsive">
              <table class="table table-striped table-lg">
                <?php
          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="verify">
           <form class="needs-validation" action="" method="POST">
              ...
              <div class=" md-form mt-0">
              <input id="myInput5" class="form-control" type="text" placeholder="Search" aria-label="Search">
              </div>
            <div class="table-responsive">
              <table class="table table-striped table-lg">
                <?php
